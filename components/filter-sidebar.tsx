        ...
        <div className='space-y-6'>
          ...
          Сбросить все
            ...
            <div className='space-y-4'>
                ...
                <Accordion type='multiple' defaultValue={['categories', 'dietary', 'rating', 'sellers']}
                           className='w-full'>
                            ...
                            <div className='space-y-2'>
                                {categories.map((category) => (
                                    <div key={category} className='flex items-center space-x-2'>
                                        ...
                                        />
                                        <Label
                                            htmlFor={`category-${category}`}>{categoryTranslations[category] || category}</Label>
                                    </div>
                                ))}
                            </div>
                        </AccordionContent>
                            ...
                            <div className='space-y-2'>
                                {dietaryOptions.map((option) => (
                                    <div key={option} className='flex items-center space-x-2'>
                                        ...
                                        />
                                        <Label
                                            htmlFor={`dietary-${option}`}>{dietaryTranslations[option] || option}</Label>
                                    </div>
                                ))}
                            </div>
                        </AccordionContent>
