                        ...
                        {sortedProducts.map((product) => (
                            <Card key={product.id} className='overflow-hidden'>
                                <div className='aspect-square relative'>
                                    <Image src={product.image || '/placeholder.svg'} alt={product.name} fill
                                    ...
                                    <div className='absolute top-2 right-2'>
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align='end'>
                                                ...
                                                <DropdownMenuSeparator/>
                                                <DropdownMenuItem className='text-destructive'>Удалить
                                                    товар</DropdownMenuItem>
                                            </DropdownMenuContent>
                                        </DropdownMenu>
                                    </div>
                                ...
                                <CardContent className='p-4'>
                                    ...
                                    <div className='mt-2 text-sm text-muted-foreground'>
                                        <div className='flex justify-between'>
                                            <span>Запасы:</span>
                                            <span
                                                className={product.inventory === 0 ? 'text-destructive' : ''}>{product.inventory} шт.</span>
                                        </div>
                                        <div className='flex justify-between'>
                                            <span>Продажи:</span>
                                ...
                                {sortedProducts.map((product) => (
                                    <div key={product.id} className='flex items-center p-4 gap-4'>
                                        ...
                                        <div className='flex-1 min-w-0'>
                                            ...
                                            <div
                                                className='flex flex-col sm:flex-row items-start sm:items-center text-sm gap-2 sm:gap-6 mt-1'>
                                                ...
                                                <div className='flex items-center gap-1'>
                                                    ...
                                                    <span
                                                        className={product.inventory === 0 ? 'text-destructive font-medium' : 'font-medium'}>
