                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value='International Desserts'>Международные
                                                    десерты</SelectItem>
                                            </SelectContent>
                                        </Select>
                                    </div>
                            ...
                            <CardContent className='space-y-4'>
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <div className='flex items-center space-x-2'>
                                        ...
                                        />
                                        <Label htmlFor='lowStockAlert'>Уведомлять по email, когда запасы
                                            заканчиваются</Label>
                                    </div>
                                </div>
                            </CardContent>
                            ...
                            <CardContent>
                                ...
                                >
                                    <div className='flex flex-col items-center justify-center gap-2 text-center'>
                                        ...
                                        <p className='text-sm text-muted-foreground mb-2'>или нажмите кнопку ниже для
                                            выбора файлов</p>
                                        <input
                                            name='images'
                                            ref={fileInputRef}
                                ...
                                {images.length > 0 && (
                                    <div className='space-y-2'>
                                        <div className='flex justify-between items-center'>
                                            ...
                                            <p className='text-sm text-muted-foreground'>Перетаскивайте изображения для
                                                изменения порядка</p>
                                        </div>
