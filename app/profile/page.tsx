                                    ...
                                    <form onSubmit={profileForm.handleSubmit(onProfileSave)}>
                                        <CardContent className='space-y-4'>
                                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                                <FormField control={profileForm.control} name='first_name'
                                                           render={({field}) => (
                                                               <FormItem>
                                                ...
                                                <FormField control={profileForm.control} name='last_name'
                                                           render={({field}) => (
                                                               <FormItem>
                                            ...
                                            <FormField control={profileForm.control} name='phone_number'
                                                       render={({field}) => (
                                                           <FormItem>
                                            ...
                                            >
                                                ...
                                                <FormField control={profileForm.control} name='address'
                                                           render={({field}) => (
                                                               <FormItem>
                                                ...
                                                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                                                    <FormField control={profileForm.control} name='city'
                                                               render={({field}) => (
                                                                   <FormItem>
                                                                       <FormLabel>Город</FormLabel>
                                                                       <FormControl><Input
                                                                           placeholder='Москва' {...field} /></FormControl>
                                                                       <FormMessage/>
                                                                   </FormItem>
                                                               )}/>
                                                    <FormField control={profileForm.control} name='postal_code'
                                                               render={({field}) => (
                                                                   <FormItem>
                                                                       <FormLabel>Индекс</FormLabel>
                                                                       <FormControl><Input
                                                                           placeholder='123456' {...field} /></FormControl>
                                                                       <FormMessage/>
                                                                   </FormItem>
                                                               )}/>
                                                    <FormField control={profileForm.control} name='country'
                                                               render={({field}) => (
                                                                   <FormItem>
                                                                       <FormLabel>Страна</FormLabel>
                                                                       <FormControl><Input
                                                                           placeholder='Россия' {...field} /></FormControl>
                                                                       <FormMessage/>
                                                                   </FormItem>
                                                               )}/>
                                                </div>
                                            ...
                                            <FormField control={passwordForm.control} name='currentPassword'
                                                       render={({field}) => (
                                                           <FormItem>
                                                               ...
                                                               <FormControl><Input
                                                                   type='password' {...field} /></FormControl>
                                                               <FormMessage/>
                                                           </FormItem>
                                                       )}/>
