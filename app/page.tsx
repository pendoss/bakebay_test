		...
		<main className='min-h-screen bg-[#e1ece7]'>
			...
			<section className='py-10'>
				<div className='container px-4 md:px-6'>
					<div className='text-center mb-16'>
						<h2 className='text-3xl font-bold tracking-tight mb-4 text-secondary'>Почему выбирают
							BakeBay?</h2>
              ...
              Мы переосмыслили процесс заказа и доставки десертов, делая его безупречным от клика до первого кусочка.
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
						<Card
							className='bg-white/80 backdrop-blur-md border-none shadow-lg hover:shadow-xl transition-all'>
			...
			<section className='py-10 relative overflow-hidden'>
                ...
                Сегодня BakeBay — это сообщество из более чем 500 кондитеров по всей стране. Каждый из них умеет готовить по-настоящему вкусно и делает это по-своему. У нас нет легенды — есть результат. Наша миссия — не сочинять сказки, а делать сладкое доступным, свежим и вовремя. Иногда этого вполне достаточно.
							...
							<Button variant='outline'
									className='group text-secondary border-secondary/30 hover:bg-secondary/5'>
								Узнать больше о нас{' '}
			...
			<section className='py-10 relative overflow-hidden'>
              ...
              Получить вкусные, свежеиспеченные угощения с доставкой так же просто, как 1-2-3
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
						<div
							className='bg-white/80 backdrop-blur-md rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all text-center'>
							<div
								className='w-16 h-16 rounded-full bg-primary text-white font-bold flex items-center justify-center mx-auto mb-6 text-2xl'>
                1
							</div>
			...
			<section className='py-10 relative overflow-hidden'>
				...
				<div className='container px-4 md:px-6 relative z-10'>
					<div className='flex flex-col md:flex-row justify-between items-start md:items-center mb-12'>
						<div>
							<h2 className='text-3xl font-bold tracking-tight mb-2 text-secondary'>Популярные
								категории</h2>
					...
					<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
						{[
							...
							<Link key={category.name} href={category.href} className='block'>
								<div
									className='bg-white/80 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all group'>
									<div
										className='h-40 bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center'>
										<category.icon
											className='h-16 w-16 text-primary/70 group-hover:scale-110 transition-transform'/>
									</div>
			...
			<section className='py-10 relative overflow-hidden'>
				...
				<div className='absolute inset-0 opacity-5 -z-10'>
					<Image src='/placeholder.svg?height=400&width=1600' alt='Фоновый узор' fill
              ...
              доставкой на дом.
						...
						<Button size='lg'
								className='bg-primary text-white hover:bg-primary/90 transition-all font-medium'>
